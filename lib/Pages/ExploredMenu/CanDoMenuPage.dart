...
class _cando_page extends State<cando_page> {
  ...
  Widget build(BuildContext context) {
    return Container(child: ListView.builder(padding: EdgeInsets.only(top: 15),itemCount: 3,itemBuilder: (context, index) {
      return Container(
                  ...
                  children: <Widget>[
                    Container(
                      child: Text(
                        'ผัดเต้าหู้มะเขือเทศ',
                        style:
                            TextStyle(color: Color(0xff914d1f), fontSize: 30),
                      ),
                    ),
                    Container(
                      child: Row(
