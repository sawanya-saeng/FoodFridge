...
class xothers_choose_page extends StatefulWidget {
  @override
  _xothers_choose_page createState() => _xothers_choose_page();
}

int click;

class _xothers_choose_page extends State<xothers_choose_page> {
