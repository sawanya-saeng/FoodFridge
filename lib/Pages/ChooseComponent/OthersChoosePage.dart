...
class others_choose_page extends StatefulWidget {
  @override
  _others_choose_page createState() => _others_choose_page();
}

int click;

class _others_choose_page extends State<others_choose_page> {
