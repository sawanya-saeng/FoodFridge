...
class xvegetable_choose_page extends StatefulWidget {
  @override
  _xvegetable_choose_page createState() => _xvegetable_choose_page();
}

int click;

class _xvegetable_choose_page extends State<xvegetable_choose_page> {
