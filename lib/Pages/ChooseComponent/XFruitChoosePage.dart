...
class xfruit_choose_page extends StatefulWidget {
  @override
  _xfruit_choose_page createState() => _xfruit_choose_page();
}

int click;

class _xfruit_choose_page extends State<xfruit_choose_page> {
