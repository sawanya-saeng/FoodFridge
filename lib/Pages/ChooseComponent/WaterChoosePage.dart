...
class water_choose_page extends StatefulWidget {
  @override
  _water_choose_page createState() => _water_choose_page();
}

int click;

class _water_choose_page extends State<water_choose_page> {
