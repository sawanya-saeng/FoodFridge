...
class _veget_page extends State<veget_page> with TickerProviderStateMixin{
  ...
  Future getMeat() async {
    ...
    _db.collection('Fridge').where('uid', isEqualTo: user.uid).where('type', isEqualTo:'vegetable').orderBy('date', descending: false).snapshots().listen((docs) {
      tmp = docs.documents;
      setState(() {
        ingres = tmp;
        items.clear();
                                    ...
                                    GestureDetector(
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context){
                                          return add_page('vegetable', true, items[index]['id'][jdex]);
                                        }));
                                      },
                                      onLongPress: (){
